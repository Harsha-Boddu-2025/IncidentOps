...
### Step 1 — Get a free NVIDIA API key (~10 min)
...
### Step 3 — Deploy free on Streamlit Community Cloud (~20 min)
...
### Step 4 — Rehearse the 3-minute demo
1. Show the sidebar: 4-agent team, powered by NVIDIA NIM.
...
## Requirement mapping (for slides / judges)
